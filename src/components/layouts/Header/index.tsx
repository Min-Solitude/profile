...
export default function Header({ className }: HeaderProps) {
    ...
    return (
        ...
        >
            <motion.div className=' w-full m-auto lg:px-0  md:w-[90%] lg:w-[80%] relative xl:w-[70%] 2xl:w-[60%] duration-150 flex flex-col items-center py-6 gap-8 md:flex-row md:justify-between md:px-8'>
                <Logo />
                <NavLink />
