        ...
        <Section className="flex  flex-col items-center pb-16">
            <div className="w-full min-h-screen duration-150 md:w-[70%] lg:w-[60%] p-3 lg:p-0 xl:w-[50%] 2xl:w-[40%] flex justify-start flex-col items-center">
                ...
                <div className='w-full flex flex-col gap-8 items-start'>
                    <Content contentChange={<h1 className='font-bold text-3xl'>Những thành tựu mà tôi đã đạt được.</h1>} >
                        <h1 className='font-bold text-3xl'>The achievements I have achieved.</h1>
                    </Content>
                    ...
                    <div className='flex flex-col gap-8'>
                        ...
                        <Content contentChange={<p className='text-base'>
                            Nó chỉ đơn giản là HTML CSS nhưng nó đã làm một dấu mốc với tôi. Đến giữa năm 2022, đây là thời điểm tôi thay đổi nhiều nhất. Tôi có được những cơ hội tham gia những cuộc thi lớn và cuộc thi đầu tiên mà tôi chinh chiến là cuộc thi FPT HACKATHON 2022 do hệ đào tạo FPT tổ chức.
                        </p>} >
                            <p className='text-base'>
                                It was simply HTML CSS but it made a mark for me. By mid-2022, this is when I changed the most. I have had opportunities to participate in major competitions and the first competition I fought in was the FPT HACKATHON 2022 competition organized by the FPT training system.
                            </p>
                        </Content>
                        <BoxDrag className='h-[30vh] md:h-[40vh] overflow-hidden rounded-2xl bg-white'>
                        ...
                        <Content contentChange={<p className='text-base'>
                            Đây là một cuôc thi về Blockchain, tôi và nhóm của mình đã xây dựng một web app passbook. Và nó đã đem lại cho nhóm giải nhì trong cuộc thi này và đây là thành tựu đầu tiên trong quá trình tìm hiểu về ngành.
                        </p>} >
                            <p className='text-base'>
                                This is a Blockchain contest, my team and I built a passbook web app. And it brought the group the second prize in this competition and this was the first achievement in the process of learning about the industry.
                            </p>
                        </Content>
                        <Content contentChange={<p className='text-base'>
                            Qua nhiều tháng sau tôi cùng nhóm của mình tham gia nhiều cuộc thi về blockchain. Và cả nhóm cũng đã có một tiếng tăm trong các cuộc thi. Điều này có thể nói là một điều may mắn và tuyệt vời.
                        </p>} >
                            <p className='text-base'>
                                Over the next several months, my team and I participated in many blockchain competitions. And the group also has a reputation in competitions. This can be said to be a lucky and wonderful thing.
                            </p>
                        </Content>
                        ...
                        <Content contentChange={<p className='text-base'>
                            Và ngoài việc tham gia các hoạt động trong lĩnh vực lập trình tôi còn tham gia các hoạt động ngoài khác. Như trở thành một người sáng tạo nội dung về lĩnh vực vẽ tranh, tham gia các buổi triễn lãm và các cuộc thi hội họa,... Hội họa chính là đam mê lớn nhất của tôi. Nó là thứ khiến tôi muốn đem sự tuyệt đẹp đó vào ngành lập trình.
                        </p>} >
                            <p className='text-base'>
                                And in addition to participating in programming activities, I also participate in other outside activities. Like becoming a content creator in the field of painting, participating in exhibitions and painting competitions,... Painting is my biggest passion. It's what makes me want to bring that beauty into programming.
                            </p>
                        </Content>
                        <Content contentChange={<p className='text-base'>
                            Và đó là những gì tôi muốn chia sẻ về những thứ tôi thấy nó là thành tựu với tôi. Cảm ơn bạn đã xem :))
                        </p>} >
                            <p className='text-base'>
                                And that's what I want to share about what I see as an achievement for me. Thank you for watching :))
                            </p>
                        </Content>
                    </div>
                </div>
